...
int main() {
    ...
    //std::cout << cc.getCourse() << std::endl;
    //cc.wFile();
    //cc.rFile();
    ...
    //temp.readTemps("temperatures.txt");
    //temp.readTemps("temperatures.txt");

    //temp.readTemps("temperatures.txt");
    temp.tempStats(temp.readTemps("temperatures.txt"));

    //std::cout << temp.readTemps("temperatures.txt") << std::endl;
    //-------------------------------------
    //-------------------------------------
    //-------------------------------------
